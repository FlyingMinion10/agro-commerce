            ...
            VStack {
                ...
                HStack {
                    ...
                    Text(ProfileView.accountType == "Bodeguero" ? chat.seller_name : chat.buyer_name)
                        .font(.headline)
                    Spacer()
                    NavigationLink (destination: TransactionScrollView(interaction_id: interaction_id, producto_completo: chat.item_preview, buyer: chat.buyer, seller: chat.seller, currentStep: monopoly.first?.step ?? 0)) {
